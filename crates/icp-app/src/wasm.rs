//! Getting hold of a wasm module a manifest names but the project does not
//! contain: over HTTP when it is a URL, from the package cache when it has
//! been fetched before.
...
use crate::package::{PackageCache, cache_wasm};
...
impl Fetch for Fetcher {
    ...
    async fn wasm(
        ...
        self.fetch(source, base_dir, sha256, reporter)
            .await
