...
/// The freezing threshold is lowered to 10 minutes before this canister is
/// installed, so liquid_balance is close to the total balance.
const RESERVE_MARGIN: u128 = 50_000_000_000;
