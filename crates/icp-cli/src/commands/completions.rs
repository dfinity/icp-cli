...
///
/// Completion is dynamic: rather than listing this version's commands and flags,
/// the script asks `icp` what to offer as you type, so it also covers the
/// canisters, networks and environments of the project you are standing in, and
/// the identities in your identity store.
#[derive(Debug, Args)]
