...
pub(crate) async fn sync_settings(
    ...
    if log_visibility_setting
        ...
        && reserved_cycles_limit.is_none_or(|s| s.0 == current_settings.reserved_cycles_limit)
    ...
    mgmt.update_settings(cid)
        ...
        .with_optional_reserved_cycles_limit(reserved_cycles_limit.as_ref().map(|r| r.0))
