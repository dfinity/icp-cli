...
fn build_multiple_canisters() {
    ...
    ctx.icp()
        ...
        .stderr(contains(
            "DEBUG icp::render::plain: [canister-a] building canister-a",
        ))
        .stderr(contains(
            "DEBUG icp::render::plain: [canister-b] building canister-b",
        ))
        .stderr(contains("DEBUG icp::render::plain: [canister-c] building canister-c").not());
}
...
fn build_all_canisters_in_environment() {
    ...
    ctx.icp()
        ...
        .stderr(contains("DEBUG icp::render::plain: [canister-c] building canister-c").not()); // not in test-env
}
