...
impl ControllerRef {
    ...
    pub fn resolve(&self, ids: &crate::ids::IdMapping) -> Option<candid::Principal> {
        match self {
...
"#;
    ...
    fn controller_ref_resolve_principal() {
        ...
        let ids = crate::ids::IdMapping::new();
    ...
    fn controller_ref_resolve_canister_name_present() {
        ...
        let mut ids = crate::ids::IdMapping::new();
