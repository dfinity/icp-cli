---
title: Upgrading from icp-cli 0.2
description: "Upgrading a project from icp-cli 0.2.x — the built-in `type: assets` sync step is removed in later releases; switch to the plugin-based asset sync."
---
