...
* `--with-icp <WITH_ICP>` — Amount of ICP to convert into cycles to fund canister creation. Uses the cycles minting canister (CMC) instead of the cycles ledger. Supports suffixes: k (thousand), m (million), b (billion), t (trillion)
